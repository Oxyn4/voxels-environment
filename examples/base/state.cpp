...
{
    boost::program_options::options_description OptionsDescription("Voxels example: xdg base state");
    ...
    boost::leaf::result<std::filesystem::path> ConfigHomeResult = base::state::GetCandidates(VariableMap);
}